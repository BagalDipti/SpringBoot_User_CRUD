...
public class User {
    ...
    @Override
    public String toString() {
        return "User [userDesignation=" + userDesignation + ", userEmail=" + userEmail

                + ", userId=" + userId + ", userMobileNo=" + userMobileNo + ", userName=" + userName + ", manager=" + manager + "]";

                + ", userId=" + userId + ", userMobileNo=" + userMobileNo + ", userName=" + userName + "]";
